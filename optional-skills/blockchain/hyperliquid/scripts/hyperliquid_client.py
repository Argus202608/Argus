#!/usr/bin/env python3
"""
Hyperliquid CLI Tool for Argus
-------------------------------------
...
def _hermes_home() -> Path:
    return Path(os.environ.get("ARGUS_HOME", "~/.argus")).expanduser()
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Hyperliquid CLI Tool for Argus")
