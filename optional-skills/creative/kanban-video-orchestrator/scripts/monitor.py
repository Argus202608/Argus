#!/usr/bin/env python3
"""
Monitor a running video-production kanban. Polls `argus kanban list` and
...
def kanban_list(tenant: str) -> list[dict]:
    ...
    try:
        ...
        pass
    # Fallback: textual parse of `argus kanban list`
    out = subprocess.run(
