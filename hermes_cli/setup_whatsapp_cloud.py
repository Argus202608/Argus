...
Argus gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Argus to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Argus needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Argus gateway in another terminal:")
    print("         argus gateway")
    print()
    ...
    print()
    print("  Docs: https://mmargus-team.github.io/Argus/docs/user-guide/")
