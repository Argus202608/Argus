...
def _warn_if_multimodal_not_ready() -> None:
    ...
    missing, pointing the user at `hermes setup multimodal`. Best-effort — any
    ...
    try:
        ...
        print(cyan("  运行 `hermes setup multimodal` 按引导补齐,"
                   "或 `hermes mm doctor` 查看完整状态。"))
        print()
    except Exception:
        pass
