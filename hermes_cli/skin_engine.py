"""Argus CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.argus/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      ...
      response_label: " ⚕ Argus "       # Response box header label
...
.. code-block:: python
    ...
    set_active_skin("mytheme")            # Switch to user skin from ~/.argus/skins/
...
Drop a YAML file in ``~/.argus/skins/<name>.yaml`` following the schema above.
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Argus — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "Argus",
            "welcome": "Welcome to Argus! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
