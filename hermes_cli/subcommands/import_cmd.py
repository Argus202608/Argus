...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a Argus backup from a zip file",
        description="Extract a previously created Argus backup into your "
        "Argus home directory, restoring configuration, skills, "
        "sessions, and data",
    )
