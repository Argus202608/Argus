...
DEFAULT_CODEX_MODELS: List[str] = [
    ...
    # Argus uses. Removed here. If OpenAI re-enables them on Codex backend,
...
def _read_cache_models(codex_home: Path) -> List[str]:
    ...
    if isinstance(entries, list):
        for item in entries:
            ...
            # public OpenAI API, while Argus openai-codex talks to the same
