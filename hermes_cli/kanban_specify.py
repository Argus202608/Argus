...
ARGUS_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("ARGUS_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)

logger = logging.getLogger(__name__)


_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Argus board.
    ...
    *,
    ...
    try:
        resp = client.chat.completions.create(
            ...
            temperature=0.3,
            max_tokens=ARGUS_KANBAN_SPECIFY_MAX_TOKENS,
