...
const desktopWindow = window as unknown as { argusDesktop?: Window['argusDesktop'] }
const initialHermesDesktop = desktopWindow.argusDesktop

function installDesktopBridge(partial: Partial<Window['argusDesktop']> = {}) {
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['argusDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['argusDesktop']['openExternal'] })
