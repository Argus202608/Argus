...
/** Why a known Argus command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Argus profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Argus Agent version', surface: exec() },
 ...
 * Argus' built-in slash commands — i.e. skill commands (`/gif-search`,
