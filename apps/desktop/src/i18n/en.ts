...
export const en: Translations = {
  ...
  boot: {
    ready: 'Argus Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Argus settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Argus Desktop…'
    },
    errors: {
      backgroundExited: 'Argus background process exited.',
      backgroundExitedDuringStartup: 'Argus background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Argus backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Argus Desktop.',
    ...
    native: {
      ...
      inputBody: 'Argus is waiting for your response.',
      turnDoneTitle: 'Argus finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Argus defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Argus is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Argus asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Argus was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Argus follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Argus is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Argus, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Argus checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Argus configuration...',
    ...
    gateway: {
      ...
      intro:
        'Argus Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Argus backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset ARGUS_DESKTOP_REMOTE_URL and ARGUS_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Argus backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Argus backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Argus Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Argus ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Argus runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Argus to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Argus to generate pets.',
      backgroundHint: 'You can close this — Argus will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Argus desktop' },
    ...
    hermesActiveSessions: (version, count) => `Argus ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Argus environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Argus will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      deleteConfirm: 'This removes the saved project from Argus. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Argus...',
    placeholderReconnecting: 'Reconnecting to Argus…',
    ...
    attachUrlDesc: 'Argus will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Argus to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Argus…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Argus…',
    ...
    unsupportedMessage: 'This version of Argus can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Argus from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Argus will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Argus desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Argus updater takes over in its own window and reopens Argus automatically when it’s done. Please don’t reopen Argus yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Argus reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Argus reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Argus needs a one-time install',
    ...
    settingUpTitle: 'Setting up Argus Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Argus CLI or desktop instance is running. Stop any running Argus instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Argus installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Argus Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Argus is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Argus…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Argus',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Argus at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Argus connects automatically',
      loopback: 'Opens your browser to sign in — Argus connects automatically',
    ...
    authorizeThere: 'Authorize Argus there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Argus there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Argus Desktop v${version}`,
      ...
      gatewayTitle: 'Argus inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Argus will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Argus is restarting...',
      askRestart: 'Ask Argus to restart the server',
      lookingRestart: taskId => `Argus is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Argus is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Argus finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Argus could not restart the server.',
      stillWorking:
        'Argus is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Argus is loading a response',
      resumeWhenBackgroundDone: count =>
        count === 1
          ? 'Will resume when the background task finishes'
          : `Will resume when ${count} background tasks finish`,
      thinking: 'Thinking',
      preparingTool: name => `Preparing ${name}`,
      toolHistory: count => `${count} ${count === 1 ? 'tool call' : 'tool calls'}`,
      // What a tool batch actually DID, grouped by tool family. A bare
      // "N tool calls" is content-free — and with thinking mode off it was the
      // only label a finished turn had. Mirrors web's summarizeStep.
    ...
    approval: {
      gatewayDisconnected: 'Argus gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.argus/config.yaml). Argus won’t ask again for commands like this — in this session or any future one.`,
    ...
    tool: {
      ...
      argsLabel: 'Arguments',
      argsChars: count => `${count} chars (not shown)`,
      argsWithheld: 'withheld (credential)',
      argsItems: count => `${count} ${count === 1 ? 'item' : 'items'}`,
      argsElided: count => `+${count} more ${count === 1 ? 'field' : 'fields'} (not shown)`,
  ...
  prompts: {
    ...
    sudoDesc: 'Argus needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Argus needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Argus Desktop to use Save Image.',
    restartToSaveImages: 'Restart Argus Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `argus gateway` running?'
    }
  },
  ...
  errors: {
    ...
    openLogs: 'Open logs',
    turnFailed: 'The turn failed without returning a response.'
  },
  ...
  multimodal: {
    heading: 'Multimodal',
    welcome: {
      title: 'Start a multimodal conversation',
      body: 'Ask a question directly, or turn on camera / screen share — the video frame will be sent along with your question to a vision-capable agent.'
    },
    composer: {
      listening: 'Listening…',
      micError: err => `Microphone failed: ${err}`,
      micStopRecording: 'Click to stop recording',
      micReady: 'Microphone ready, waiting for speech… click to cancel',
      ...
      micLabelEndSend: 'Stop recording and send',
      micLabelFinalizing: 'Finalizing recognition and sending',
      micLabelConnecting: 'Preparing microphone, click to cancel',
      micLabelStart: 'Start a single voice input',
      asrFailed: msg => `Voice recognition failed: ${msg}`,
      micFailedTitle: msg => `Microphone failed: ${msg}`,
      ttsAriaOn: 'Turn off speech',
      ttsAriaOff: 'Turn on speech',
      dialogNeedFinishMic: 'Please finish the current single recording before starting voice dialog',
      askPlaceholder: 'Ask a question, or turn on camera / screen share',
      askWithVideoPlaceholder: 'Ask a question (once video is on, the frame is sent with your question)…',
      stopGenerating: 'Stop generating',
      stopShort: 'Stop',
      send: 'Send',
      recordingHint: 'Recording… click the mic to finish and send',
      thinkingProcess: 'Thinking process',
      needConfirm: 'Needs your confirmation',
      answerPlaceholder: 'Enter your answer',
      answerPlaceholderEnter: 'Enter your answer, press Enter to submit…',
      submit: 'Submit',
      readAloud: 'Read aloud',
      noMoreInfo: '(No further information)',
      voiceInput: 'Voice input',
      monitorTag: 'Monitor alert',
      selectedLabel: answer => `Selected: ${answer}`,
      emptyChoice: '(empty)'
    },
    video: {
      camera: 'Camera',
      ...
      connectionPaused: 'Connection lost, recording paused',
      recLabel: (source, frames) => `REC · ${source === 'camera' ? 'Camera' : 'Screen'} · ${frames} frames`,
      recDropped: n => `(dropped ${n})`,
      previewLabel: (source, phase) => `Preview · ${source === 'camera' ? 'Camera' : 'Screen'} · ${phase}`,
      startCamera: 'Camera',
      startScreen: 'Screen share',
      stopCapture: source => `Stop ${source === 'camera' ? 'camera' : 'screen share'}`,
      cameraError: msg => `Camera failed: ${msg}`,
      screenError: msg => `Screen share failed: ${msg} (macOS: grant permission in System Settings → Privacy & Security → Screen Recording)`,
      resuming: 'Resuming session; video recording available after completion.',
      captureDiag: detail => `Capture diagnostics: ${detail}`
    },
    screenPicker: {
      title: 'Choose a window or screen to share',
      loading: 'Reading window list…',
      noSources: 'No shareable sources found.',
      macPermission: 'On macOS, first grant Argus permission in System Settings → Privacy & Security → Screen Recording, then restart the app.',
      tabScreen: 'Entire screen',
      tabWindow: 'Window',
      shareAudioEnabled: 'Capture system audio (Loopback) along with screen share',
      shareAudioDisabled: 'No system audio channel available for the current OS version',
      shareAudioLabel: 'Share audio too',
      shareAudioNote: '(Requires Windows or macOS 13+)',
      cancel: 'Cancel',
    ...
    observations: {
      ...
      injectedFramesHint: '(When video is streaming, the frames the model actually sees this turn appear here)',
    ...
    deepAnalysis: {
      title: 'Deep Analysis',
      titleWithLabel: label => `🔬 Deep Analysis · ${label}`,
      completed: 'Completed',
      ...
      toolCall: (name, arg) => `🔧 Call ${name}${arg ? `(${arg})` : ''}`,
      toolFailed: (name, error) => `⚠️ ${name} call failed: ${error}`,
      searchLookup: query => `🔎 Search "${query}"`,
      memoryLookup: query => `🧩 Memory "${query}"`,
      lookupLine: (kind, query, result) => `${kind === 'search' ? '🔎 Search' : '🧩 Memory'} "${query}"${result ? ` → ${result}` : '…'}`,
      noInterpretation: '📝 No independent interpretation for this segment; content merged into report below',
      waitingFrames: 'Waiting for new frames…',
      waitingFramesSeg: seg => `Segment ${seg} waiting for new frames…`,
      accumulatingSeg: (seg, have, need) => `Segment ${seg} accumulating frames… ${have}/${need}`,
      accumulating: (have, need) => `Accumulating frames… ${have}/${need}`,
      ttlRemaining: sec => `· ⏱ ${sec}s remaining`,
      completedHint: 'Deep analysis completed; create a new task to analyze again',
      previewWaiting: seg => `⏳ ${seg !== undefined ? `Segment ${seg} ` : ''}waiting for new frames…`,
      previewAccumulating: (have, need, seg) => `⏳ ${seg !== undefined ? `Segment ${seg} ` : ''}accumulating video frames… (${have}/${need})`,
      previewSaw: desc => `👁 ${desc}`,
      previewSegAnalyzing: seg => `🎬 Analyzing segment ${seg}…`
    },
    monitor: {
      title: 'Monitor',
      count: n => `${n}`,
    ...
    watcher: {
      title: 'Deep Analysis',
      count: n => `${n}`,
      fallbackLabel: 'Deep Analysis',
      completedHint: 'Deep analysis completed; create a new task to analyze again',
      stoppingHint: 'Waiting for current round to finish',
      inProgress: 'In progress',
      completed: 'Completed',
      stopping: 'Stopping',
      interrupted: 'Interrupted',
      switchLabel: (label, state) => `${label}: ${state}`
    },
    trajectory: {
      title: 'QueryWorker full trajectory',
      working: 'Working',
      completed: 'Completed',
      waitingFirstEntry: 'Waiting for QueryWorker’s first structured trajectory entry…',
      subtitle: 'Structured execution record: frozen frames, OCR, planned/actual tools, evidence and results; hidden chain-of-thought not included.',
      actualCall: 'Actual call',
      plannedCall: 'Planned call',
      toolReturned: 'Tool returned',
      chars: n => `${n} chars`,
      frames: n => `${n} frames`,
      frozenInputTitle: 'Frozen input frames at ask-time (actual input seen by QueryWorker)',
      recallEvidenceTitle: 'Recall evidence frames',
      inputFrame: n => `Input frame ${n}`,
      clickToEnlarge: 'Click to enlarge',
      evidenceFrame: 'Evidence frame',
      ocrHelperTitle: n => `OCR helper text · ${n}`,
      ocrSkipped: 'OCR skipped.',
      ocrSkippedReason: reason => `OCR skipped: ${reason}.`,
      ocrTimeout: 'OCR timed out; QueryWorker continued with the original frame.',
      ocrError: 'OCR extraction failed; QueryWorker continued with the original frame.',
      ocrErrorReason: reason => `OCR extraction failed: ${reason}; QueryWorker continued with the original frame.`,
      ocrNoText: 'OCR completed but no usable text was recognized.',
      ocrTimeUnknown: 'Time unknown',
      ocrNoTextInFrame: '(No text recognized in this frame)',
      evidenceLabel: (kind, range) => `${kind}${range ? ` ${range}` : ''}`,
      evidenceMemoryKind: 'Memory',
      framesCompact: n => `${n} frames`,
      rawEvent: (event, phase) => `Raw event · ${event} / ${phase}`
    },
    ocr: {
      helperAvailable: n => `OCR helper text · ${n} record${n === 1 ? '' : 's'}`,
    ...
    recall: {
      traceTitle: (steps, tools) => `Recall trace · ${steps} step${steps === 1 ? '' : 's'}${tools ? ` · ${tools} internal tool${tools === 1 ? '' : 's'}` : ''}`,
      traceSubtitle: 'Structured decisions and evidence summary; hidden chain-of-thought is not shown.',
      decisionSummary: summary => `Decision summary: ${summary}`,
      started: n => `Accepted question and locked ask-time · frozen input frames ${n}`,
      analysisStart: 'Starting analysis, deciding Recall / Search',
      recallCall: (toolName, round) => `Recall call · ${toolName}${round ? ` · outer round ${round}` : ''}`,
      startRecall: 'Starting multimodal memory recall',
      roundRead: (round, count) => `Recall round ${round} memory read · ${count} result${count === 1 ? '' : 's'}`,
      roundDistill: round => `Recall round ${round} distilled valid clues`,
      roundDecisionContinue: round => `Recall round ${round} decision · continue`,
      roundDecisionStop: round => `Recall round ${round} decision · stop`,
      roundSkipDuplicate: round => `Recall round ${round} skipped duplicate memory read`,
      visualReview: (kept, total) => `Recall visual review · kept ${kept}/${total} frames`,
      quickTool: (toolName, len) => `Recall quick tool · ${toolName} · ${len} char evidence`,
      failed: stage => `Recall request failed${stage ? ` · ${stage}` : ''}`,
      completeFound: n => `Recall complete · ${n} clue${n === 1 ? '' : 's'}`,
      completeNotFound: 'Recall complete · no reliable clues found',
      returnFound: (n, frames) => `Recall returned · ${n} clue${n === 1 ? '' : 's'}${frames ? ` · ${frames} frame${frames === 1 ? '' : 's'}` : ''}`,
      returnNotFound: frames => `Recall returned · no reliable clues found${frames ? ` · ${frames} frame${frames === 1 ? '' : 's'}` : ''}`,
      searchReturn: len => `Search returned · ${len} char evidence`,
      ...
      subtaskFailed: (channel, target) => `${channel} subtask failed · ${target}`,
      phase: (phase, round) => `Recall ${phase}${round ? ` · round ${round}` : ''}`,
      planRound: (recallCount, searchCount) => `Completed a planning round${recallCount ? ` · Recall ${recallCount}` : ''}${searchCount ? ` · Search ${searchCount}` : ''}`,
      ...
      roundDecision: (round, verdict) => `Recall round ${round} decision · ${verdict}`,
      decisionEnough: 'evidence is sufficient',
      decisionContinueTools: n => `continue with ${n} more tool${n === 1 ? '' : 's'}`,
      decisionNoTools: 'no follow-up tools',
      evidenceSummary: text => `Evidence summary: ${text}`,
      noVisualConflict: 'No visual conflicts found that needed correction',
      searchCall: toolName => `Search call · ${toolName}`,
      searchStart: 'starting search',
      searchPhase: phase => `Search ${phase}`,
      taskCancelled: 'Task cancelled',
      taskFailed: 'Task failed',
      outerRound: round => `outer round ${round}`,
      innerRounds: n => `inner rounds ${n}`,
      evidenceChars: n => `${n} char evidence`,
      parallelRead: seconds => `parallel read ${seconds}s`,
      newEvidenceFrames: n => `new evidence frames ${n}`,
      cluesSoFar: n => `clues so far ${n}`
    },
    readiness: {
    ...
    capture: {
      notStarted: 'Capture not started',
      waitingSession: 'Waiting for session',
      initBackend: 'Initializing multimodal backend',
      staleRejected: 'Multimodal backend rejected a stale capture generation',
      sessionChanged: 'Target session has changed',
      gatewayUnavailable: 'Gateway unavailable',
      gatewayState: state => `WebSocket state is ${state}`,
      firstFrameTimeout: 'Video started but first frame not ready within 2 seconds',
      streamStopped: 'Video stream stopped',
      streamReplaced: 'Video stream replaced',
      authorized: 'Video authorized, waiting for backend session',
      creatingSession: 'Video authorized, creating backend session and starting recording',
      cancelled: 'Video authorized but backend session creation was cancelled',
      noSessionId: 'No backend session ID available for this chat',
      videoNotReady: 'Preview started but videoWidth/videoHeight still 0',
      encodeFailed: 'Canvas/JPEG encoding returned empty result',
      notifyRejected: 'First frame not written to backend FrameBuffer',
      creatorNotReady: 'Video authorized but session creator not ready'
    },
    voiceErrors: {
      streamingNotEnabled: 'Streaming voice not enabled (requires dashscope_api_key in config)',
      sharedAudioSliceFailed: reason => `Shared audio slice failed: ${reason}`,
      sharedAudioNotReceived: reason => `Shared audio ASR not received: ${reason}`,
      sharedAudioAsrFailed: reason => `Shared audio ASR request failed: ${reason}`,
      sharedAudioNoSamples: 'Shared audio received no valid samples. Check macOS "Screen & System Audio Recording" permission, then stop and re-share the screen.',
      sharedAudioStartFailed: detail => `Shared audio recording failed to start: ${detail}`,
      micPermissionDenied: 'Microphone permission was denied',
      turnMismatch: 'Voice turn ID does not match the backend',
      sessionCreateFailed: 'Could not create a voice session, please try again',
      connectionUnavailable: 'Voice connection unavailable, please try again',
      asrEmpty: 'No speech recognized, please try again or check your microphone input device',
      asrFinishTimeout: 'Speech recognition timed out, please try again',
      asrDispatchFailed: 'Speech was recognized but sending failed, please try again',
      asrServiceUnavailable: 'Speech recognition service is temporarily unavailable, please try again',
      asrTurnStale: 'This recording turn is no longer valid, please record again',
      submitFailedWithReason: reason => `Voice could not be submitted (${reason})`,
      submitFailedGeneric: 'Voice could not be submitted, please try again',
      recordingFinalizeFailed: 'Failed to finalize the recording, please try again',
      audioUploadInterrupted: 'Audio upload was interrupted, please try again'
    },
    chat: {
      showVideo: 'Show video stream',
      hideVideo: 'Hide video stream',
      stopReading: 'Stop reading'
    },
    misc: {
      errorPrefix: 'Error',
      ...
      foundChars: (chars, clues) => `Found ${chars} chars${clues}`,
      clues: n => ` · ${n} clue${n === 1 ? '' : 's'}`,
      cannotEnableMonitor: 'Cannot enable monitor',
      cannotEnableResearch: 'Cannot enable deep research',
      cannotPauseResearch: 'Cannot pause deep research'
    },
    memoryDebug: {
      panelTitle: 'Multimodal Memory Debug',
      panelSubtitle: 'Evidence frames · OCR · entities · events · evolution · Worker trajectory',
      refreshLabel: 'Refresh Memory Debug',
      dbSelectLabel: 'Memory database',
      noDbOption: 'No Memory database for the current session',
      tabMemory: 'This session',
      tabFrame: 'Frame details',
      tabSearch: 'Search',
      tabDebug: 'Advanced Debug',
      otherSessionNotice: 'You are manually viewing another session\'s Memory; it will not be written to or affect the current conversation.',
      noMemoryYet: 'This session has not written any Memory yet. Turn on the camera or screen share and generate observations, then refresh; you can also manually pick a historical database above.',
      statFrames: 'Memory frames',
      statEntities: 'Entities',
      statEvents: 'Events',
      statEvolution: 'Evolution records',
      inDbTotal: total => `${total} total in database`,
      section1Title: '1. Which frames were kept this time',
      section1Hint: 'Shows only evidence frames that actually entered memory_frames.',
      viewAllAndOcr: 'View all and OCR',
      noFramesYet: 'No memory frames written this time.',
      section2Title: '2. Which entities appeared this time',
      section2Hint: 'People, objects, places and their attributes, aliases and evidence frames.',
      noEntities: 'No entities extracted yet.',
      seenCount: n => `seen ${n} times`,
      aliases: list => `Aliases: ${list}`,
      section3Title: '3. Which events occurred this time',
      section3Hint: 'micro is local observation, macro is stage summary, super is cross-stage narrative.',
      noEvents: 'No events formed yet.',
      section4Title: '4. How entities and events evolved',
      section4Hint: 'Shows state changes and Reviewer revisions over time.',
      noEvolution: 'No evolution or revision records yet.',
      searchLabel: 'Search Memory',
      searchPlaceholder: 'Search OCR, tables, events and voice',
      scopeAll: 'All sessions',
      scopeToday: 'Today',
      scopeLatest: 'Selected database',
      searchButton: 'Search',
      searchEmpty: 'Enter a keyword and click Search; search does not poll automatically.',
      trajectoryGroupTitle: 'Worker trajectory · grouped by question',
      trajectoryGroupHint: 'Attributed to a question only by explicit parent/client/task mapping; continuous Memory/OCR/Reviewer events without a reliable link are not force-attached to the nearest question by time.',
      trajectoryOtherSession: 'Historical Memory databases do not persist live trajectory; to avoid confusion, the current session\'s Worker trajectory is not overlaid here. Switch back to the current session database to view live Debug.',
      trajectoryEmpty: 'No trajectory yet. It appears in real time after you start capturing, ask, Recall or Monitor.',
      noRecallMessages: 'No persisted Recall messages.',
      backgroundTrajectory: 'Continuous background / unlinked events',
      showEarlier: 'Collapse earlier events',
      showAllEvents: n => `Show all ${n}`,
      noFrameImage: 'No frame image',
      noDescription: '(No description)',
