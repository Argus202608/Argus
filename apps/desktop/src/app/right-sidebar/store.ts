...
const TAKEOVER_KEY = 'argus.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Argus can't clear via the API — the user
 *  sees exactly what runs instead of Argus silently deleting their creds. */
