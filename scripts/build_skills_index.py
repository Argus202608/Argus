#!/usr/bin/env python3
"""Build the Argus Skills Index — a centralized JSON catalog of all skills.
...
`argus skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building Argus Skills Index...", flush=True)
