...
quarantine retry / reboot-deferred fallback during `argus update` on Windows.
...
def test_quarantine_actionable_warning_when_everything_fails(
    ...
    assert "Argus Desktop" in captured or "gateway" in captured.lower()
