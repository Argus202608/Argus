"""Tests for the canonical Argus API-server toolset."""
...
class TestArgusApiServerToolset:
    """Tests for the argus-api-server toolset definition."""

    def test_toolset_exists(self):
        ts = get_toolset("argus-api-server")
        assert ts is not None

    def test_toolset_validates(self):
        assert validate_toolset("argus-api-server")

    def test_toolset_includes_web_tools(self):
        tools = resolve_toolset("argus-api-server")
...
class TestApiServerPlatformConfig:
    def test_platforms_dict_includes_api_server(self):
        ...
        assert PLATFORMS["api_server"]["default_toolset"] == "argus-api-server"
...
class TestApiServerAdapterToolset:
    ...
    def test_create_agent_reads_config_toolsets(self):
        ...
        with patch("gateway.run._resolve_runtime_agent_kwargs") as mock_kwargs, \
            ...
            # No platform_toolsets override — should fall back to Argus default
