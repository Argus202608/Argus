#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Argus docs site.
...
Both publish at:
  https://mmargus-team.github.io/Argus/docs/llms.txt
  https://mmargus-team.github.io/Argus/docs/llms-full.txt
...
SITE_BASE = "https://mmargus-team.github.io/Argus/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Argus as a Python Library", None),
        ("guides/use-mcp-with-argus", "Use MCP with Argus", None),
        ("guides/use-voice-mode-with-argus", "Use Voice Mode with Argus", None),
        ("guides/use-soul-with-argus", "Use SOUL.md with Argus", None),
        ("guides/build-an-argus-plugin", "Build an Argus Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Argus"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "> The self-improving multimodal AI agent built by MMArgus Team. A terminal-native "
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/MMArgus-Team/"
        "Argus/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/MMArgus-Team/Argus")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Argus — Full Documentation\n",
        (
            "This file is the entire Argus documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Argus, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://mmargus-team.github.io/Argus/docs\n",
        "Short index: https://mmargus-team.github.io/Argus/docs/llms.txt\n",
        "\n---\n\n",
    ]
