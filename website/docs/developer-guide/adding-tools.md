...
sidebar_position: 2
title: "Adding Tools"
description: "How to add a new tool to Argus Agent — schemas, handlers, registration, and toolsets"
---
...
This page is for adding a **built-in Argus tool** to the repository itself.
If you want a personal, project-local, or otherwise custom tool without
modifying Argus core, use the plugin route instead:

- [Plugins](/user-guide/features/plugins)
- [Build an Argus Plugin](/guides/build-an-argus-plugin)
...
- [ ] Tested with `argus chat -q "Use the weather tool for London"`
