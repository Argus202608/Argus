...
slug: /
sidebar_position: 0
title: "Argus Agent Documentation"
description: "The self-improving multimodal AI agent built by MMArgus Team. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [MMArgus Team](https://github.com/MMArgus-Team). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `argus setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Argus safely  |
| 🧭 **[Use MCP with Argus](/guides/use-mcp-with-argus)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Argus](/guides/use-voice-mode-with-argus)** | Hands-on setup and usage patterns for Argus voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Argus' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Argus                              |
...
- **Built by model trainers** — Created by [MMArgus Team](https://github.com/MMArgus-Team). Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [MMArgus Team](https://github.com/MMArgus-Team)
