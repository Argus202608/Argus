...
| | |
|---|---|
| Source | Optional — install with `argus skills install official/research/qmd` |
...
Argus via the native MCP client. This is the preferred
...
Then configure Argus to connect via HTTP:
