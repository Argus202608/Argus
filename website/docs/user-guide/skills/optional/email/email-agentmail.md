...
| | |
|---|---|
| Source | Optional — install with `argus skills install official/email/agentmail` |
...
```
argus --toolsets mcp -q "Create an AgentMail inbox called test-agent and tell me its email address"
```
