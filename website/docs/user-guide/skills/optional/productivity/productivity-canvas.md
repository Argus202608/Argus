...
| | |
|---|---|
| Source | Optional — install with `argus skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Argus"), set an optional expiry, and click **Generate Token**
