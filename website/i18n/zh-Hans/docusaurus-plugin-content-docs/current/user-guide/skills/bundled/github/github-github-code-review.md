...
```bash
source "${ARGUS_HOME:-$HOME/.hermes}/skills/github/github-auth/scripts/gh-env.sh"
...
```bash
# 若无问题——批准
gh pr review $PR_NUMBER --approve --body "Reviewed by Argus. Code looks clean — good test coverage, no security concerns."
