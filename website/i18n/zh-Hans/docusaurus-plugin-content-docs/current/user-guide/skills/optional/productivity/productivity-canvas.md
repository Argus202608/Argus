...
| | |
|---|---|
| 来源 | 可选 — 通过 `argus skills install official/productivity/canvas` 安装 |
...
4. 为 token 命名（例如 "Argus"），设置可选的过期时间，然后点击 **Generate Token**
...
```bash
CANVAS="python $ARGUS_HOME/skills/productivity/canvas/scripts/canvas_api.py"
