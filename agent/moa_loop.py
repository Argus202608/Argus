...
MoA-enabled; the normal Argus loop still owns tool calling and turn
...
def aggregate_moa_context(
    *,
    ...
    synth_prompt = (
        ...
        "Argus. Focus on next steps, tool-use strategy, risks, and any "
    ...
    return (
        ...
        "normal Argus loop. You may call tools, continue reasoning, or "
        "finish normally.]\n"
