...
def openclaw_residue_hint_cli() -> str:
    """Banner shown the first time Argus starts and finds ``~/.openclaw/``.
    ...
    return (
        ...
        "To port your config, memory, and skills over to Argus, run "
        "`argus claw migrate`.\n"
        "If you've already migrated and want to archive the old directory, "
        "run `argus claw cleanup` (renames it to ~/.openclaw.pre-migration — "
