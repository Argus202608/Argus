...
MM_QUERY_CONTRACT_MARKER = "Multimodal-Query-Contract: query_multimodal/v1"
...
MM_LIVE_GUIDANCE = (
    ...
    "content, call query_multimodal. This includes identifying an object, person, place, logo, text, action, "
    ...
    "says so. QueryWorker receives the ask-time recent frames and decides whether to "
    "answer directly, use multimodal Recall, use Search, or combine them. Do not guess from text-only context.\n"
    ...
    "Multimodal memories of past stream events are separate from text memory. QueryWorker accesses them "
    "through RecallAgent behind query_multimodal. After calling query_multimodal, do not write a provisional "
    "answer or wait to synthesize its result: QueryWorker replies directly to the user's original message.\n"
    ...
    "For set_monitor, set_live_watcher, and query_multimodal, make the tool call without a prose preamble. "
    "These tools transfer reply ownership and terminate your turn from their deterministic result; never spend a second model turn paraphrasing their receipt.\n"
)
